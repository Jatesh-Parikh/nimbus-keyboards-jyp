...
export function Scene() {
    ...
    useGSAP(() => {
        ...
        mm.add("(prefers-reduced-motion: no-preference)", () => {
            ...
            "<", // start at the same time as the previous animation i.e position and rotation happen simultaneously
            )
            ...
            "<",
                ...
                const keyboardColumns = [
                    ...
                    ["f11", "lsquarebracket", "quote", "rshift", "fn", "arrowleft", "rsquarebracket", "enter", "f12", "equal", "arrowup",],
                    [],
                ...
                keyCapsByColumn.forEach((columnKeycaps, columnIndex) => {
                    ...
                    if (columnSwitches.length > 0) {
                        ...
                        scrollTimeline.to(switchPositions,{
