        ...
        <header className="fixed top-0 right-0 left-0 z-50 flex items-center justify-between p-3 md:p-6">
            ...
            <div className="flex gap-3 md:gap-4">
                <button
                    ...
                    className={clsx("group relative flex h-12 transform-gpu cursor-pointer items-center justify-center overflow-hidden rounded bg-gradient-to-r from-[#01A7E1] to-[#0196C9] px-6 py-2.5 font-semibold text-white will-change-transform hover:shadow-lg hover:shadow-[#01A7E1]/25 focus:ring-2 focus:ring-[#01A7E1] focus:ring-offset-2 focus:outline-none disabled:grayscale motion-safe:transition-all motion-safe:duration-300 md:text-base", "before:absolute before:inset-0 before:translate-x-[-100%] before:bg-gradient-to-r before:from-white/0 before:via-white/20 before:to-white/0 before:ease-out hover:before:translate-x-[100%] motion-safe:before:transition-transform motion-safe:before:duration-700")}
                >
                    <span className="font-bold-slanted relative z-10 flex items-center gap-2 text-xl uppercase">
                        Buy
                        <LuChevronRight className="size group-hover:translate-x-0.5 motion-safe:transition-transform motion-safe:duration-200" />
                    </span>
                </button>
                <Dialog open={open} onOpenChange={setOpen}>
                    <DialogTrigger
                        className="flex size-12 cursor-pointer items-center justify-center rounded bg-gray-300 hover:bg-gray-300/80 hover:shadow-lg hover:shadow-black/10 motion-safe:transition"
                    >
