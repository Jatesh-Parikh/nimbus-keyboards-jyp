                ...
                <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
                    <div className="text-center">
                        ...
                        <h1 className="font-bold-slanted mt-8 text-4xl text-gray-900 sm:text-5xl lg:text-6xl">
                            ...
                            <span className="block bg-gradient-to-r from-red-500 to-red-600 bg-clip-text tracking-tight text-transparent uppercase">Went Wrong</span>
                        </h1>
                        <p className="mx-auto mt-6 max-w-2xl text-lg text-gray-600">No session ID found</p>
                        <Link 
                            href="/" 
                        ...
                        >
                            Return Home <LuChevronRight className="h-5 w-5" />
                        </Link>
                    </div>
                </div>
            </div>
                     ...
                     <div className="mt-12 text-center">
                        ...
                        <div className="grid gap-6 md:grid-cols-3">
                            ...
                            <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
                                ...
                                <p className="text-sm text-gray-600">
                                    We&apos;re preparing your keyboard and will ship it within 2-3 business days.
                                </p>
                            </div>
                            ...
                            <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
                                ...
                                <p className="text-sm text-gray-600">
                                    Your keyboard will arrive in 5-7 business days with tracking information.
                                </p>
                            </div>
                        </div>
                     </div>
                     ...
                     <div className="mt-12 flex flex-col justify-center gap-4 sm:flex-row">
                        ...
                        >
                            <span className="flex items-center gap-2 text-lg">
                                <LuCircleHelp className="h-5 w-5" /> Need Help?
                            </span>
                        </Link>
                     </div>
                </FadeIn>
